...
std::shared_ptr<CWallet> TestCreateWallet(WalletContext& context, int account = 0);
std::shared_ptr<CWallet> TestCreateWallet(std::unique_ptr<WalletDatabase> database, WalletContext& context, uint64_t create_flags, int account = 0);
