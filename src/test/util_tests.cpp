...
BOOST_AUTO_TEST_CASE(util_FormatISO8601Date)
{
    ...
    BOOST_CHECK_EQUAL(FormatISO8601Date(1), "1970-01-01");
    BOOST_CHECK_EQUAL(FormatISO8601Date(946684801), "2000-01-01");
    BOOST_CHECK_EQUAL(FormatISO8601Date(1317425777), "2011-09-30");
    BOOST_CHECK_EQUAL(FormatISO8601Date(4133980799), "2100-12-31");
    BOOST_CHECK_EQUAL(FormatISO8601Date(253402300799), "9999-12-31");
}
